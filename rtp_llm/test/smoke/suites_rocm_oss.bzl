    ...
    native.test_suite(
        ...
        tests = [
            smoke_test(
                ...
                smoke_args={
                    "prefill": "--load_cache_timeout_ms 120000 --load_method scratch --warm_up 0 --act_type BF16 --seq_size_per_block 1024 --kernel_seq_size_per_block 16 --test_block_num 64 --max_seq_len 12800 --tp_size 1 --world_size 1 --ep_size 1 --reuse_cache 1 --use_asm_pa 0 --use_aiter_pa 1 --use_triton_pa 0 --reserver_runtime_mem_mb 40480 --quantization FP8_PER_CHANNEL_COMPRESSED --use_swizzleA 1 --sp_model_type qwen35_dense_mtp --gen_num_per_cycle 3 --sp_type eagle --sp_checkpoint_path /ckpt/qwen35/Qwen3.5-27B --sp_act_type bf16 --cache_store_rdma_mode 0 --use_local 1 --role_type PREFILL",
                    "decode": "--load_cache_timeout_ms 120000 --load_method scratch --warm_up 0 --act_type BF16 --seq_size_per_block 1024 --kernel_seq_size_per_block 16 --test_block_num 64 --max_seq_len 12800 --tp_size 1 --world_size 1 --ep_size 1 --reuse_cache 1 --use_asm_pa 0 --use_aiter_pa 1 --use_triton_pa 0 --reserver_runtime_mem_mb 40480 --quantization FP8_PER_CHANNEL_COMPRESSED --use_swizzleA 1 --sp_model_type qwen35_dense_mtp --gen_num_per_cycle 3 --sp_type eagle --sp_checkpoint_path /ckpt/qwen35/Qwen3.5-27B --sp_act_type bf16 --cache_store_rdma_mode 0 --use_local 1 --role_type DECODE --concurrency_limit 4 --enable_cuda_graph 1 --enable_cuda_graph_debug_mode 1 --decode_capture_config '1,2,3,4'",
                },
                gpu_type=["MI308X-ROCM7"],
            ),
        ],
